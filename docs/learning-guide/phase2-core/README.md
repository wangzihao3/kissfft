...
1. **[KISS FFT 剖析](./kiss_fft_anatomy.md)** - 整体架构概览
   - 项目结构
   - 核心数据结构
   - 主函数分析

2. **[数据类型分析](./data_types.md)** - 定点和浮点实现
   - 定点数表示
   - 定标策略
   - 溢出处理

3. **[构建系统分析](./build_system.md)** - 编译和配置
   - CMake 配置
   - 编译选项
   - 平台适配
...
#### [FFT 数学公式完整推导](./fft-mathematical-derivation.md)
**数学基础篇** - 从第一性原理理解 FFT
...
#### [蝶形运算详细说明](./butterfly-operations.md)
**理论可视化篇** - 蝶形图的绘制和解读
...
#### [kf_bfly 代码分析](./kf_bfly-code-analysis.md)
**源码解析篇** - 逐行分析 KISS FFT 实现

- kf_bfly2/3/4/5/generic 详解
- 代码与数学公式对照
- 宏定义分析
- 优化技巧总结
...
```
1. 先读 [KISS FFT 剖析] 建立整体概念
   ↓
2. 根据需要选择深入学习文档：

   路径 A - 理论优先：
   [FFT 数学推导] → [蝶形运算说明] → [kf_bfly 代码分析]

   路径 B - 实践优先：
   [kf_bfly 代码分析] → [蝶形运算说明] → [FFT 数学推导]
